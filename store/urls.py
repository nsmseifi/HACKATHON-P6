...
def call_router(app):
    ...
    app.route('/stores/<id>', 'DELETE', store_controller.delete,
              apply=[check_auth, inject_db, timeit])
    app.route('/stores', 'POST', store_controller.add,apply=[inject_db,pass_data,jsonify])
    app.route('/stores/_search', 'POST', store_controller.search_store,
